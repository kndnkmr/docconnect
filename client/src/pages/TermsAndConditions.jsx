  ...
  return (
    <div>
      ...
      <div className="space-y-6 text-gray-700 text-sm leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-semibold text-gray-800 mb-2">7. Cancellation & Refunds</h2>
          <ul className="list-disc ml-6 space-y-1">
            <li>Patients can cancel appointments before the scheduled time</li>
        ...
        <section>
          <h2 className="text-lg font-semibold text-gray-800 mb-2">8. Account Termination</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-gray-800 mb-2">11. Grievance Officer</h2>
